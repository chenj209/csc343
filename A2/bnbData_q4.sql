...
-- Add 10 TravelerRating record, 4000 has three 5 star, one 4 star and one 1 star, improved.
...
-- 4001 has two 1 star, three 4 star, not improved
...
-- Add a HomeOwner who has no rating, discard.
